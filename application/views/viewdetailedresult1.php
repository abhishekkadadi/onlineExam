...
<!--  removeeeeeeeeeeeeeeeeeeeee  -->
                 ...
                 <div class="col-md-12">
					...
					<div class="col-md-3 "></div>
                	<div class="col-md-6 mymargin">
					<div id="divResultStatistics" style="width: 100%;" class="">
       
            <table class="ib-dgray" cellspacing="2" cellpadding="4" style="font-size:12px; border:2px solid #69b831; background-color:#fafafa;" width="100%">
            <tbody><tr><td align="center" bgcolor="#69b831" colspan="3"><b style="font-size: 12pt; color: #FFF;">Marks :<?php echo $marksGained."/".$TotalTestMarks;?> </b></td></tr>
            <tr>
                <td>Total number of questions</td>
                <td width="1%">:</td>
                <td width="10%" nowrap="nowrap" align="right" style="padding-right:40px"><b><?php echo $number_questions;?></b></td>
            </tr>
            <tr>
                <td>Number of answered questions</td>
                <td width="1%">:</td>
                <td align="right" style="padding-right:40px"><b><?php echo $right_ans_count+$wrong_ans_count;?></b></td>
            </tr>
             <tr>
                <td>Number of Right Answered</td>
                <td width="1%">:</td>
                <td align="right" style="padding-right:40px"><b><?php echo $right_ans_count;?></b></td>
            </tr>
            <tr>
                <td>Number of Wrong Answered</td>
                <td width="1%">:</td>
                <td align="right" style="padding-right:40px"><b><?php echo $wrong_ans_count;?></b></td>
            </tr>

            <tr>
                <td>Marks Deducted</td>
                <td width="1%">:</td>
                <td align="right" style="padding-right:40px"><b><?php echo $marksDeducted;?></b></td>
            </tr>

            <tr>
                <td>Number of unanswered questions</td>
                <td width="1%">:</td>
                <td align="right" style="padding-right:40px"><b><?php echo $not_answered;?></b></td>
            </tr>
            <tr>
                <td>Percentage</td>
                <td width="1%">:</td>
                <td align="right" style="padding-right:40px"><b><?php echo $percentage1;?></b></td>
            </tr>
           
            </tbody></table>
            <?php if($percentage1<='40'){
					echo '<label style="margin-right:2px;">Remark: </label><b style="color: red;">Poor Performance ( Need to study hard)</b>';
			}?>
			<?php if($percentage1>'40' && $percentage1<'50'){
					echo '<label style="margin-right:2px;">Remark: </label><b style="color: red;">Average Performance . (Need to increase study )</b>';
			}?>
			<?php if($percentage1>='50' && $percentage1<'55'){
					echo '<label style="margin-right:2px;">Remark: </label><b style="color: red;">Good Performance</b>';
			}?>
			<?php if($percentage1>='55' && $percentage1<'65'){
					echo '<label style="margin-right:2px;">Remark: </label><b style="color: red;">Best Performance</b>';
			}?>
			<?php if($percentage1>='65' && $percentage1<'75'){
					echo '<label style="margin-right:2px;">Remark: </label><b style="color: red;">Excellent Performance</b>';
			}?>
			<?php if($percentage1>='75'){
					echo '<label style="margin-right:2px;">Remark: </label><b style="color: red;">Genius Performance</b>';
			}?>
        </div>	
			</div>
			<div class="col-md-3 "></div>	
